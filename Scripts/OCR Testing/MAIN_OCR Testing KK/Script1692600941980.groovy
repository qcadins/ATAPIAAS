...
def filterSaldo() {
    ...
    inputDDLExact('Object Repository/API_KEY/Page_Balance/inputtipesaldo', findTestData(ExcelPathOCRTesting).getValue(
            GlobalVariable.NumOfColumn, rowExcel('$SearchTipeSaldo')))

    'isi field tipe transaksi'
    inputDDLExact('Object Repository/API_KEY/Page_Balance/inputtipetranc', findTestData(ExcelPathOCRTesting).getValue(
