...
for(GlobalVariable.NumOfColumn; GlobalVariable.NumOfColumn <= CountColumnEdit; (GlobalVariable.NumOfColumn)++)
{
	...
	if(UseCorrectKey == 'Yes')
	{
		...
		response = WS.sendRequest(findTestObject('Object Repository/OCR Testing/OCR BPKB', [('img'): findTestData(ExcelPathOCRTesting).getValue(GlobalVariable.NumOfColumn, 8),
