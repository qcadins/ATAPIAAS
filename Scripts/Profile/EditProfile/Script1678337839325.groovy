...
for (GlobalVariable.NumOfColumn; GlobalVariable.NumOfColumn <= countColumnEdit; (GlobalVariable.NumOfColumn)++) {
	...
	if (findTestData(ExcelPathEditProfile).getValue(GlobalVariable.NumOfColumn, 1).length() == 0){
		...
		WebUI.setText(findTestObject('Object Repository/Profile/Page_Edit Profile/input__position'), 
			findTestData(ExcelPathEditProfile).getValue(GlobalVariable.NumOfColumn, 18))
		...
		WebUI.selectOptionByLabel(findTestObject('Object Repository/Profile/Page_Edit Profile/select__country'),
			findTestData(ExcelPathEditProfile).getValue(GlobalVariable.NumOfColumn, 19), false)
